...
public class SearchingByEditedAndRangeStart implements Specification<Comment> {
    private final LocalDateTime start;

    @Override
    public Predicate toPredicate(Root<Comment> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        return criteriaBuilder.greaterThanOrEqualTo(root.get(Comment_.edited), start);
    }
}
