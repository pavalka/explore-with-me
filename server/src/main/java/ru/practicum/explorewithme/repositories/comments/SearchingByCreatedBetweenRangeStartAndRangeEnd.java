...
public class SearchingByCreatedBetweenRangeStartAndRangeEnd implements Specification<Comment> {
    private final LocalDateTime start;
    private final LocalDateTime end;

    @Override
    public Predicate toPredicate(Root<Comment> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        return criteriaBuilder.between(root.get(Comment_.created), start, end);
    }
}
